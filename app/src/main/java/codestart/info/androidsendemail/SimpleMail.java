...
public class SimpleMail {
    ...
    private static final String SMTP_AUTH_USER = "oumastmohamed15@gmail.com"; //your login username/email
    private static final String SMTP_AUTH_PWD  = "alhamdolilah0987"; //password/secret
    ...
    public static void sendEmail(String to, String subject, String msg){
        ...
        String from = "oumastmohamed15@gmail.com"; //from
